...
<%-----------------------------------------------------------------------------
	ChartCategoriesDialog fragment
--%>
<TABLE CELLPADDING="0px" CELLSPACING="0px" CLASS="dialog_content_table" STYLE="width: 100%;">
	<TR>  
		...
		<TR>
			<TD WIDTH="75px">
				<fmt:message key="chartCategoriesDialog.text.category" bundle="${dialogBundle}"/>
			</TD>
			<TD>
				<DIV ID="<%=IVParameterAccessor.getHtmlId(IIVConstants.IV_CHART_CATEGORIES_DIALOG_JS)%>_category"></DIV> 
			</TD>			
		</TR>
		</TABLE>
		</TD>
